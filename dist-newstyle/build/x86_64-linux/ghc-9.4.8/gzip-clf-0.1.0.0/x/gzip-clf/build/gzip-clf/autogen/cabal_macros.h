...
/* package gzip-clf-0.1.0.0 */
#ifndef VERSION_gzip_clf
#define VERSION_gzip_clf "0.1.0.0"
#endif /* VERSION_gzip_clf */
#ifndef MIN_VERSION_gzip_clf
#define MIN_VERSION_gzip_clf(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_gzip_clf */
...
#define CURRENT_COMPONENT_ID "gzip-clf-0.1.0.0-inplace-gzip-clf"
